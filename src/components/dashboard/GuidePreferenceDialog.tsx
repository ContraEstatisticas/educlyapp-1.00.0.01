...
export const GuidePreferenceDialog = ({
  ...
  return (
    <Dialog open={open}>
      <DialogContent
        className="max-w-3xl overflow-hidden rounded-[2rem] border-border bg-card p-0 shadow-2xl [&>button]:hidden"
        onEscapeKeyDown={(event) => event.preventDefault()}
        onInteractOutside={(event) => event.preventDefault()}
      >
        <div className="relative overflow-hidden bg-gradient-to-br from-primary/12 via-background to-blue-500/10 p-6 md:p-8">
            ...
            {options.map((option) => {
              ...
              return (
                ...
                >
                  ...
                  <div className={`rounded-[1.5rem] border border-border/50 bg-gradient-to-br ${option.accentClass} p-4`}>
                  ...
                  <div className="mt-4 flex items-start gap-3">
                    <div className={`inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl ${option.iconWrapClass}`}>
