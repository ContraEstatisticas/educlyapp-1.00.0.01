...
const EN_UI: AiTrailUiCopy = {
  ...
  toastDescription: "Some specialized AI trails are still in progress. MidJourney is already open.",
  backToDashboard: "Back to dashboard",
  dashboardEyebrow: "Trails by AI",
  dashboardTitle: "8 separate trails",
...
const PT_UI: AiTrailUiCopy = {
  ...
  toastTitle: "Em breve",
  toastDescription: "Algumas trilhas especializadas por IA ainda estao em montagem. A MidJourney ja esta liberada.",
  backToDashboard: "Voltar ao dashboard",
  dashboardEyebrow: "Trilhas por IA",
  dashboardTitle: "8 trilhas separadas",
...
const ES_UI: AiTrailUiCopy = {
  ...
  toastDescription: "Algunas rutas especializadas por IA todavia estan en preparacion. MidJourney ya esta disponible.",
  backToDashboard: "Volver al dashboard",
  dashboardEyebrow: "Rutas por IA",
  dashboardTitle: "8 rutas separadas",
...
const FR_UI: AiTrailUiCopy = {
  ...
  availableNow: "Disponible",
  toastTitle: "Bientot",
  toastDescription: "Certains parcours IA sont encore en preparation. MidJourney est deja disponible.",
  backToDashboard: "Retour au dashboard",
  dashboardEyebrow: "Parcours par IA",
  dashboardTitle: "8 parcours separes",
...
const TRAIL_META_BY_LANG: Record<AiTrailLang, Record<string, TrailMetaCopy>> = {
  ...
  fr: {
    ...
    deepseek: { category: "Code et logique", signature: "Une pensee technique plus profonde." },
