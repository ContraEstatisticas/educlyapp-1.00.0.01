...
const EN_UI: AiTrailUiCopy = {
  ...
  challengeTitle: "Some AIs will have their own trails",
  challengeButton: "See AI trails",
  hubBadge: "Trails by AI",
  hubTitle: "8 focused trails built for selected AIs.",
  hubTotalLabel: "Total",
...
const PT_UI: AiTrailUiCopy = {
  ...
  challengeTitle: "Algumas IAs terao suas proprias trilhas",
  challengeButton: "Ver trilhas por IA",
  hubBadge: "Trilhas por IA",
  hubTitle: "8 trilhas focadas criadas para IAs selecionadas.",
  hubTotalLabel: "Total",
...
const ES_UI: AiTrailUiCopy = {
  ...
  challengeTitle: "Algunas IAs tendran sus propias rutas",
  challengeButton: "Ver rutas por IA",
  hubBadge: "Rutas por IA",
  hubTitle: "8 rutas enfocadas creadas para IAs seleccionadas.",
  hubTotalLabel: "Total",
...
const FR_UI: AiTrailUiCopy = {
  ...
  challengeTitle: "Certaines IA auront leurs propres parcours",
  challengeButton: "Voir les parcours IA",
  hubBadge: "Parcours par IA",
  hubTitle: "8 parcours cibles crees pour des IA selectionnees.",
  hubTotalLabel: "Total",
