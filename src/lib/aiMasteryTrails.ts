...
export const aiMasteryTrails: MasteryTrail[] = [
  ...
  withToolVisual("grok", {
    ...
    summary: "Uma trilha pratica para usar Grok em pesquisa, leitura de contexto, criacao de conteudo, automacao e exploracao criativa.",
    category: "Tempo real e leitura de cenario",
    intensity: "Radar de sinais",
    durationLabel: "6 modulos",
    lessonCount: 6,
    deliverable: "Base de pesquisa, visual, marketing, automacao, voz e criatividade com Grok",
    ...
    modules: [
      ...
      { title: "Marketing com Grok", summary: "Copies, campanhas, posts, roteiros, publico e funis com IA.", outcome: "Base pratica para acelerar criacao e teste de marketing." },
      { title: "Automacao com Grok", summary: "Mapeamento de tarefas, fluxos, integracoes e refinamento de processos.", outcome: "Base pratica para reduzir retrabalho com automacoes simples." },
      { title: "Chat de voz com Grok", summary: "Conversa natural, ideias rapidas, aprendizado guiado e refinamento por voz.", outcome: "Base pratica para usar voz com mais clareza e dinamismo." },
      { title: "Criatividade com Grok", summary: "Brainstorming, perspectivas, narrativas e conceitos originais com apoio da IA.", outcome: "Base pratica para transformar exploracao criativa em projetos mais fortes." },
    ],
  }),
  ...
  withToolVisual("gamma", {
    ...
    modules: [
      { title: "O que e o Gamma e por que ele Mudou a Forma de Criar Apresentacoes", summary: "Conheca o Gamma, o sistema de cards e os casos de uso praticos.", outcome: "Entendimento claro do que o Gamma faz e como ele se diferencia." },
      { title: "Criando sua Primeira Apresentacao do Zero com o Gamma", summary: "Do prompt inicial ao resultado final, passo a passo.", outcome: "Capacidade de criar apresentacoes completas com prompts claros." },
      { title: "Editando e Personalizando sua Apresentacao no Gamma", summary: "Ajustando conteudo, reorganizando cards e refinando com IA.", outcome: "Dominio da edicao com precisao e refinamento via IA." },
      { title: "Recursos Avancados do Gamma — IA, Embeds e Interatividade", summary: "Videos, graficos, Gamma Agent e redesign com um clique.", outcome: "Dominio dos recursos que transformam apresentacoes em experiencias interativas." },
    ],
  }),
];
