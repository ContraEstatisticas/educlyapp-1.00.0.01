...
const QUICK_REPLY_RULES: QuickReplyRule[] = [
  {
    ...
    responses: buildQuickReplyResponses({
      pt: "Para cancelamento ou cobranca, escolha uma opcao:\n1. Abrir a tela de contato: https://educly.app/contato\n2. Enviar email para: contact@educly.app",
      en: "For cancellation or billing, choose an option:\n1. Open the contact page: https://educly.app/contato\n2. Send an email to: contact@educly.app",
      es: "Para cancelacion o cobros, elige una opcion:\n1. Abrir la pagina de contacto: https://educly.app/contato\n2. Enviar un email a: contact@educly.app",
      fr: "Pour annulation ou facturation, choisissez une option :\n1. Ouvrir la page de contact : https://educly.app/contato\n2. Envoyer un email a : contact@educly.app",
      de: "Fur Kundigung oder Abrechnung wahlen Sie eine Option:\n1. Kontaktseite offnen: https://educly.app/contato\n2. E-Mail senden an: contact@educly.app",
      it: "Per cancellazione o fatturazione, scegli un'opzione:\n1. Apri la pagina di contatto: https://educly.app/contato\n2. Invia un'email a: contact@educly.app",
      ru: "Po voprosam otmeny ili oplaty vyberite variant:\n1. Otkryt stranicu kontaktov: https://educly.app/contato\n2. Otpravit email na: contact@educly.app",
      tr: "Iptal veya faturalama icin bir secenek belirleyin:\n1. Iletisim sayfasini acin: https://educly.app/contato\n2. Su adrese email gonderin: contact@educly.app",
      pl: "W sprawie anulowania lub platnosci wybierz opcje:\n1. Otworz strone kontaktu: https://educly.app/contato\n2. Wyslij email na: contact@educly.app",
      nl: "Kies voor annulering of facturatie een optie:\n1. Open de contactpagina: https://educly.app/contato\n2. Stuur een e-mail naar: contact@educly.app",
    }),
  },
  {
    id: "pricing_plan",
...
const getSystemPrompt = (language: string, aiToolContext?: string): string => {
  ...
  const cancellationRoutingRules: Record<string, string> = {
    pt: "## SUPORTE DE CANCELAMENTO\nSe o usuario solicitar cancelamento (assinatura, cobranca, pausa ou chargeback), encaminhe sempre para o canal oficial: https://educly.app/contato . Seja direto e objetivo.",
    en: "## CANCELLATION SUPPORT\nIf the user asks for cancellation (subscription, billing, pause or chargeback), always direct them to the official channel: https://educly.app/contato . Keep it short and clear.",
    es: "## SOPORTE DE CANCELACION\nSi el usuario solicita cancelacion (suscripcion, cobro, pausa o contracargo), dirigelo siempre al canal oficial: https://educly.app/contato . Se breve y claro.",
    fr: "## SUPPORT D'ANNULATION\nSi l'utilisateur demande une annulation (abonnement, facturation, pause ou contestation), redirigez-le toujours vers le canal officiel : https://educly.app/contato . Soyez bref et clair.",
    de: "## KUNDIGUNGS-SUPPORT\nWenn der Nutzer eine Kundigung anfragt (Abo, Abrechnung, Pause oder Chargeback), verweisen Sie immer auf den offiziellen Kanal: https://educly.app/contato . Kurz und klar antworten.",
    it: "## SUPPORTO CANCELLAZIONE\nSe l'utente richiede cancellazione (abbonamento, addebito, pausa o chargeback), indirizzalo sempre al canale ufficiale: https://educly.app/contato . Rispondi in modo breve e chiaro.",
    ru: "## ПОДДЕРЖКА ОТМЕНЫ\nЕсли пользователь просит отмену (подписки, списания, паузы или чарджбэка), всегда направляйте его на официальный канал: https://educly.app/contato . Отвечайте кратко и ясно.",
  };
